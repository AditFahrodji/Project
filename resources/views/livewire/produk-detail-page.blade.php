              ...
              <div class="flex-1 px-4">
                  <div class="sticky top-0 z-50 overflow-hidden ">
                      <div class="relative mb-6 lg:mb-10 lg:h-2/4 ">
                          <img x-bind:src="`{{ url('storage', $produk->gambar) }}`" alt="{{ $produk->nama }}" class="object-cover w-full h-full">
                      </div>
                  ...
                  <div class="lg:pl-20">
                      <div class="mb-8 ">
                          ...
                          <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                              <span> {{ Number::currency($produk->harga, 'IDR') }} </span>
                          </p>
                      ...
                      <div class="w-32 mb-8 ">
                          <label for="" class="w-full pb-1 text-xl font-semibold text-gray-700 border-b border-blue-300 dark:border-gray-600 dark:text-gray-400">Size</label>
                          <select wire:model="size" class="block w-full mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                      ...
                      <div class="flex flex-wrap items-center gap-4">
                          <button wire:click='addToCart({{ $produk->id }})' class="w-full p-4 bg-blue-500 rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-700">
                              <span wire:loading.remove wire:target='addToCart({{ $produk->id }})'>Add to cart</span><span wire:loading wire:target='addToCart({{ $produk->id }})' class="text-gray-50">Adding...</span>
                          </button>
                      </div>
                  </div>
              </div>
